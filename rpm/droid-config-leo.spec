...
%define device_pretty Mi Note Pro
...
%include patterns/patterns-sailfish-device-adaptation-leo.inc
%include patterns/patterns-sailfish-device-configuration-leo.inc
